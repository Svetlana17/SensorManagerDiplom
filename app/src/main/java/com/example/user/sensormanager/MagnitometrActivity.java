...
public class MagnitometrActivity extends AppCompatActivity implements SensorEventListener{
        ...
        setContentView(R.layout.activity_magnitometr);
...
*/
        ...
        mSensorManager.unregisterListener((SensorEventListener) MagnitometrActivity.this);
        thread.interrupt();
        super.onDestroy();
    }
    }
